...
class MyFinishedPage extends StatefulWidget {
  const MyFinishedPage({Key? key}) : super(key: key);

  @override
  State<MyFinishedPage> createState() => _MyFinishedPage();
}

class _MyFinishedPage extends State<MyFinishedPage> {
  @override
